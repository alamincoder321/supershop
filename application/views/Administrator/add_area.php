			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" id="district" name="district" placeholder="Area Name"
						value="<?php echo set_value('district'); ?>" class="col-xs-10 col-sm-4" />
					<span id="msg"></span>
					...
					<div class="col-xs-10 col-sm-4" style="padding:0px;">
						<select name="forbidden_categories" id="forbidden_categories" class=" form-control " multiple>
							<?php foreach ($categories as $row) { ?>
								<option value="<?php echo $row->ProductCategory_SlNo; ?>">
									<?php echo $row->ProductCategory_Name; ?></option>
							<?php } ?>
			...
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th>Special Discount Avialable</th>
						<th>Action</th>
					</tr>
				</thead>
...
<script type="text/javascript">
	function submit() {
		...
		var inputdata = 'district=' + district + '&delivery_charge=' + delivery_charge + '&forbidden_categories=' + forbidden_categories + '&special_discount=' + special_discount;
