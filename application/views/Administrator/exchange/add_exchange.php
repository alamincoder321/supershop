                    ...
                    <table class="table table-hover table-bordered table-striped" style="margin-bottom: 0;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in sales.saleDetails" v-if="sales.saleDetails.length > 0" style="display: none;" :style="{display: sales.saleDetails.length > 0 ? '' : 'none'}">
                                ...
                                <td>
                                    <input type="checkbox" @change="addToCart(item)" v-model="item.isExchange" :true-value="`yes`" :false-value="`no`" style="cursor:pointer;width: 18px; height: 18px; margin:0;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="card-body">
                    <table class="table table-hover table-bordered table-striped" style="margin-bottom: 0;">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">
                                    <button type="button" style="width: 100%;">Save Exchange</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
